        ...
        <>
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                * {
                ...
                .logo-block:hover img { transform: rotate(-5deg) scale(1.05); }
                ...
                .product-card:hover .product-img img { transform: scale(1.12) rotate(2deg); }
                ...
                .timeline-item:hover .step-number { transform: scale(1.1) rotateY(360deg); }
                ...
                .equipment-nodes { display: flex; justify-content: space-around; margin: 15px 0; }
                ...
                .assurance-text h2 { font-size: 2.6rem; margin-bottom: 25px; font-weight: 800; }
                .assurance-text p { color: #A9B9D1; margin-bottom: 40px; font-size: 1.15rem; }

                .why-choose-us { background-color: var(--light-bg); padding: 120px 0; }
                ...
                .feature-card:hover { transform: translateY(-8px); box-shadow: 0 25px 55px rgba(0,0,0,0.06); }
                .feature-icon { font-size: 3.5rem; color: var(--primary-blue); margin-bottom: 25px; display: inline-block; transition: var(--transition-smooth); }
                .feature-card:hover .feature-icon { transform: scale(1.2); }
                .feature-card h3 { font-size: 1.45rem; margin-bottom: 15px; color: var(--dark-grey); font-weight: 800; }
                ...
                @keyframes revealDown { 0% { transform: translateY(-40px); opacity: 0; } 100% { transform: translateY(0); opacity: 1; } }
                @keyframes revealUp { 0% { transform: translateY(40px); opacity: 0; } 100% { transform: translateY(0); opacity: 1; } }
                @keyframes technicalFlow { 0% { background-position: 0 0; } 100% { background-position: 40px 40px; } }
                @keyframes floatModule { 0% { transform: translateY(0px); } 100% { transform: translateY(-15px); } }
                @keyframes waveFlow { 0% { left: 0%; } 100% { left: -100%; } }
                @keyframes pulseNode { 0% { transform: translate(-50%, -50%) scale(0.8); opacity: 0.6; } 100% { transform: translate(-50%, -50%) scale(1.2); opacity: 1; } }
                @keyframes pulseBar { 0% { left: -30%; } 100% { left: 100%; } }
                @keyframes morphGraphic { 0% { border-radius: 30% 70% 70% 30% / 30% 30% 70% 70%; } 100% { border-radius: 60% 40% 30% 70% / 50% 60% 40% 50%; } }

                /* --- REVEAL ENGINE STATES --- */
                .reveal { opacity: 0; transform: translateY(30px); transition: opacity 0.8s ease, transform 0.8s ease; }
                .reveal.active { opacity: 1; transform: translateY(0); }

                /* --- RESPONSIVE DEVICE COMPLIANCE --- */
                @media (max-width: 1200px) { .hero h1 { font-size: 4rem; } }
                ...
                <div className="container nav-container">
                    ...
                    <nav className="nav-menu-wrapper">
                        ...
                        <ul className={`nav-links ${menuOpen ? 'open' : ''}`}>
                            <li><a href="index.html" className="active" onClick={handleLinkClick}>Home</a></li>
                            <li><a href="products.html" onClick={handleLinkClick}>Products</a></li>
                    ...
                    <div className="product-grid">
                        <div className="product-card reveal">
                            <div className="product-img">
                                src="casing-patti.png" alt="PVC Casing (Patti)" />
                            </div>
